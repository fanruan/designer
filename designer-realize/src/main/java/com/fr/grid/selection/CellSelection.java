...
public class CellSelection extends Selection {
    ...
    public boolean mergeCells(ElementCasePane ePane) {
        ...
        if (cells.hasNext()) { // alex:有两个以上的格子在这个区域内
            int returnValue = JOptionPane.showConfirmDialog(SwingUtilities.getWindowAncestor(ePane), com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Report_Des_Merger_Cell"), com.fr.design.i18n.Toolkit.i18nText("Utils-Merge_Cell"),
