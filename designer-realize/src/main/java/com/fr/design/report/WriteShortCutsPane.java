...
public class WriteShortCutsPane extends JPanel{
	...
	public JPanel getFeatureNamePane(){
		...
		panel1.setBorder(BorderFactory.createTitledBorder(com.fr.design.i18n.Toolkit.i18nText("FR-Designer_Shortcut_Set")));
		UILabel name = new UILabel(com.fr.design.i18n.Toolkit.i18nText("FR-Designer_Feature_Name"), SwingConstants.CENTER);
		name.setBounds(40, 30, 80, 50);
		UILabel nextCol = new UILabel(com.fr.design.i18n.Toolkit.i18nText("FR-Designer_Cursor_to_next_column"), SwingConstants.CENTER);
		nextCol.setBounds(140, 30, 180, 50);
		UILabel nextRow = new UILabel(com.fr.design.i18n.Toolkit.i18nText("FR-Designer_Cursor_to_next_row"), SwingConstants.CENTER);
		nextRow.setBounds(390, 30, 180, 50);
		UILabel shortName = new UILabel(com.fr.design.i18n.Toolkit.i18nText("FR-Designer_Current_keys"), SwingConstants.CENTER);
		...
		switchbt.setToolTipText(com.fr.design.i18n.Toolkit.i18nText("FR-Designer_Exchange_key"));
	...
	public JPanel getHintsPane(){
		...
		UILabel systemDefault = new UILabel(com.fr.design.i18n.Toolkit.i18nText("FR-Designer_System_default"), SwingConstants.CENTER);
		systemDefault.setBounds(38, 30, 84, 50);
		UILabel preColText = new UILabel(com.fr.design.i18n.Toolkit.i18nText("FR-Designer_Cursor_to_previous_column"), SwingConstants.CENTER);
		preColText.setBounds(140, 30, 190, 50);
		UILabel preRowText = new UILabel(com.fr.design.i18n.Toolkit.i18nText("FR-Designer_Cursor_to_previous_row"), SwingConstants.CENTER);
