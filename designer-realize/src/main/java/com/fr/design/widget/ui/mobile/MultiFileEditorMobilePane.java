...
public class MultiFileEditorMobilePane extends WidgetMobilePane {
    private static final Item[] ITEMS = {
            new Item(com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Report_Take_Photos_And_Choose_From_Album"), FileUploadModeState.TAKE_PHOTOS_AND_CHOOSE_FROM_ALBUM),
            new Item(com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Report_Only_Take_Photos"), FileUploadModeState.ONLY_TAKE_PHOTOS)
    };
    ...
    private UIExpandablePane getMobileSettingsPane() {
        ...
        Component[][] components = new Component[][]{
                new Component[] {new UILabel(com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Report_Upload_Mode"), SwingConstants.LEFT), uploadModeComboBox}
        };
        ...
        return new UIExpandablePane(com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Report_Terminal"), 280, 20, panelWrapper);
    }
