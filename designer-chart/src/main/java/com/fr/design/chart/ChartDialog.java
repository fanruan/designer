...
public class ChartDialog extends MiddleChartDialog {
    ...
    private void initComponent() {
    	...
    	setTitle(com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Chart_M-Popup_Chart_Type"));
    	...
    	ok = new UIButton(com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Chart_OK"));
