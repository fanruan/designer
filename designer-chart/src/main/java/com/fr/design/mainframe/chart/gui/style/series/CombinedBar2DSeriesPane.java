...
public class CombinedBar2DSeriesPane extends Bar2DSeriesPane{
    ...
    protected JPanel getContentInPlotType() {
        ...
        Component[][] components = new Component[][]{
                new Component[]{new UILabel(com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Chart_New_Column"))},
                new Component[]{fillColorPane, null},
                new Component[]{stylePane, null},
                new Component[]{new BoldFontTextLabel(com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Chart_Change_Bar_Size")),zoomTime}
        };
