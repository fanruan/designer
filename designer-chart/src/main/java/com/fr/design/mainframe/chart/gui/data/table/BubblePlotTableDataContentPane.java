...
public class BubblePlotTableDataContentPane extends AbstractTableDataContentPane {
    ...
    public BubblePlotTableDataContentPane(ChartDataPane parent) {
        ...
        Component[][] components = new Component[][]{
                     new Component[]{north},
                     new Component[]{TableLayout4VanChartHelper.createExpandablePaneWithTitle(com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Chart_Data_Filter"),dataScreeningPane), null},
             };
