...
public class VanChartRadarYAxisPane extends VanChartValueAxisPane {
    ...
    protected JPanel createMinMaxValuePane(double[] row, double[] col) {
        ...
        valueStyle = new UIButtonGroup<Integer>(new String[]{com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Chart_UnifiedComputing"),
                com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Chart_RespectivelySpecified")});

        JPanel commenPane = createCommenValuePane(new double[]{p, p, p}, columnSize);
        tableDataPane = new RadarTableDataPane();

        centerPane = new JPanel(new CardLayout());
        centerPane.add(commenPane, com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Chart_UnifiedComputing"));
        centerPane.add(tableDataPane, com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Chart_RespectivelySpecified"));
    ...
    private void checkRadarCardPane() {
        if (centerPane != null && valueStyle != null) {
            ...
            if (valueStyle.getSelectedIndex() == 0) {
                cardLayout.show(centerPane, com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Chart_UnifiedComputing"));
            } else {
                cardLayout.show(centerPane, com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Chart_RespectivelySpecified"));
            }
        }
    }
