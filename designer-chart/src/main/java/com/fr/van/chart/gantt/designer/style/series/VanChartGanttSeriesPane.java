...
public class VanChartGanttSeriesPane extends VanChartAbstractPlotSeriesPane {
    ...
    private JPanel createGanntStylePane(){
        seriesNewLine = new UIButtonGroup(new String[]{com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Chart_Open"), com.fr.design.i18n.Toolkit.i18nText("Plugin-ChartF_Close")});
