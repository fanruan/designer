...
public class VanChartCustomStackAndAxisConditionPane extends BasicBeanPane<ConditionAttr> {
    ...
    private JPanel createDeployPane() {
        isStacked = new UIButtonGroup<Integer>(new String[]{com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Chart_YES"), com.fr.design.i18n.Toolkit.i18nText("Plugin-ChartF_NO")});
        isPercentStacked = new UIButtonGroup<Integer>(new String[]{com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Chart_YES"), com.fr.design.i18n.Toolkit.i18nText("Plugin-ChartF_NO")});
