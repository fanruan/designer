...
public class VanChartGaugePlotLabelPane extends VanChartPlotLabelPane {
    ...
    protected void createLabelPane() {
        ...
        String cateTitle, valueTitle = com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Chart_ValueLabel");
        switch (gaugeStyle){
            case POINTER:
            ...
            case POINTER_SEMI:
                ...
                break;
            default:
                cateTitle = com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Chart_PercentLabel");
                break;
        }
