...
public class VanChartGaugeSeriesPane extends VanChartAbstractPlotSeriesPane {
    ...
    private JPanel createGaugeLayoutPane() {
        ...
        JPanel panel = TableLayout4VanChartHelper.createGapTableLayoutPane(com.fr.design.i18n.Toolkit.i18nText("Fine-Design_Chart_Page_Setup_Orientation"),gaugeLayout);
